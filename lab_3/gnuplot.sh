...
set output "double.esp"      # Nazwa obrazka
...
set ylabel "||r||_2" tc rgb "red" offset 2, 0      # Podpis LEWEJ osi OY
set y2label "||x||_2" tc rgb "blue" rotate by -90  # Podpis PRAWEJ osi OY
...
plot "zad_a.dat" u 1:2 ls 1 t "||r||_2, x_0=0", \
"" u 1:4 ls 2 t "||x||_2, x_0=0" axes x1y2, \
"zad_b.dat" u 1:2 w lp ls 3 t "||r||_2, x_0=1", \
"" u 1:4 w lp ls 4 t "||x||_2, x_0=1" axes x1y2
